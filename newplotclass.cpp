...
void newplotclass::setparameter(double WindowsWidth, double WindowsHight, double Xrang, double Yrange,
                                double main_value,double up_telorance,double low_telorance,QString Title)
{
...
//    if(Nominal-Lo_tel < Up_tel-Nominal )
//    {

//    customPlot->yAxis->setRange((Lo_tel-Nominal)*10,(Up_tel-Nominal)*1.2);
//    textTicker->addTick(up_telorance-main_value, QString::number(up_telorance));
//    textTicker->addTick((low_telorance-main_value)-0.01, QString::number(low_telorance));
...
//    }
//   else if(Nominal-Lo_tel > Up_tel-Nominal)
//    {

//        customPlot->yAxis->setRange((Lo_tel-Nominal)*1.2,(Up_tel-Nominal)*1.2);
//        textTicker->addTick((up_telorance-main_value)+0.01, QString::number(up_telorance));
//        textTicker->addTick(low_telorance-main_value, QString::number(low_telorance));

//        QCPItemLine *Up_parallelLine=new QCPItemLine(customPlot);
//        Up_parallelLine->start->setCoords(0,up_telorance-main_value+0.01);
//       Up_parallelLine->end->setCoords(21,up_telorance-main_value+0.01);
//        QCPItemLine *Down_parallelLine=new QCPItemLine(customPlot);
//        Down_parallelLine->start->setCoords(0,(low_telorance-main_value));
//        Down_parallelLine->end->setCoords(21,low_telorance-main_value);
//        QVector<qreal> dashPattern;
...
//        pen_Yellow.setStyle(Qt::CustomDashLine);
//        pen_Yellow.setStyle(Qt::DotLine);  // Set the line style to dotted
//        pen_Yellow.setWidth(2);            // Set line width
//        pen_Yellow.setDashPattern(dashPattern);
//        Up_parallelLine->setPen(pen_Yellow);
//        pen_Yellow.setDashPattern(dashPattern);
//        Down_parallelLine->setPen(pen_Yellow);
...
//     customPlot->yAxis->setRange((Lo_tel-Nominal),(Up_tel-Nominal));
//      customPlot->yAxis->setRange((Lo_tel-Nominal)*1.2,(Up_tel-Nominal)*10);
//     customPlot->yAxis->setRange((Lo_tel-Nominal)/10,(Up_tel-Nominal)*1.2);
//      qDebug()<<"Nominal-Lo_tel :"<<(Nominal-Lo_tel);
//       qDebug()<<"Up_tel-Nominal :"<<Up_tel-Nominal;
    customPlot->replot();
...
QString s;
postcounter++;
textLable[0]->position->setCoords(1,-copysign(1,data-Nominal)*(Up_tel-Nominal)*0.015);
//textLable[0]->position->setCoords(1,-copysign(1,data-Nominal));
//textLable[0]->position->setCoords(1,-copysign(1,data-Nominal)*(Up_tel-Nominal)*0.1);
//textLable[0]->position->setCoords(1,-copysign(1,data-Nominal)*(Up_tel-Nominal)/10);
//textLable[0]->position->setCoords(1,0);
// qDebug()<<"data-Nominal: :"<<data-Nominal;
// qDebug()<<"-copysign(1,data-Nominal) :"<<-copysign(1,data-Nominal);
textLable[0]->setText(s.number(data, 'f', 2));
// qDebug()<<"Up_tel-Nominal :"<<Up_tel-Nominal;
// qDebug()<<"-copysign(1,data-Nominal)*0.19 :"<<-copysign(1,data-Nominal)*(Up_tel-Nominal)*0.19;
// qDebug()<<"-copysign(1,data-Nominal)/10 :"<<-copysign(1,data-Nominal)*(Up_tel-Nominal)/10;
//textLable[0]->setText(s.setNum(postcounter));
//textLable[0]->setText(s.number(data));
//textLable[0]->setFont(QFont(font().family(),8));
...
customPlot->replot();
for (int k=19;k>0;k--) {
    textLable[k]->setFont(QFont(font().family(),7));
